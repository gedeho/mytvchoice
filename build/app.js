...
_vue2.default.component('chanl-list', {
	template: '#channel-list',
	data: function data() {
		return {
			checkedNames: _jsCookie2.default.getJSON('channelselection') || ["2", "3", "13", "5", "6", "1"]
		};
	},
	methods: {
		addChannel: function addChannel() {
			_jsCookie2.default.set('channelselection', this.checkedNames, { expires: 7 });
		},
...
_vue2.default.component('program-card', {
	props: ['prog'],
	template: '#prog-card',
	data: function data() {
		return {
	...
	computed: {
		startInMs: function startInMs() {
			return (0, _moment2.default)(this.prog.start).format('x');
		},
		endInMs: function endInMs() {
			return (0, _moment2.default)(this.prog.end).format('x');
		},
		timeBetweenStartAndEnd: function timeBetweenStartAndEnd() {
			return this.endInMs - this.startInMs;
		},
		progressionStyle: function progressionStyle() {
	...
	methods: {
		getProgression: function getProgression() {
...
var app = new _vue2.default({
	...
	computed: {
		currentDate: function currentDate() {
			return (0, _moment2.default)().format('dddd DD MMMM YYYY');
		}
	},
	mounted: function mounted() {
	...
	methods: {
		refresh: function refresh(value, action) {
			var _this = this;
			this.active = value;
